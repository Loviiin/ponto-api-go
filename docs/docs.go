...
const docTemplate = `{
        ...
        "/relatorios/geral": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "ID do usuário (opcional, se omitido retorna todos os usuários ativos)",
                        "name": "usuario_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/relatorio.RelatorioGeralDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "403": {
                        "description": "Sem permissão ou tentativa de acessar usuário com nível hierárquico igual ou superior",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/relatorios/geral/export": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "ID do usuário (opcional, se omitido exporta todos)",
                        "name": "usuario_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Limite de usuários por página (padrão: 50)",
                        "name": "limite",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "relatorio.RelatorioDiaDTO": {
            "type": "object",
            "properties": {
                "carga_esperada_hhmm": {
                    "type": "string"
                },
                "carga_esperada_minutos": {
                    "type": "integer"
                },
                "data": {
                    "type": "string"
                ...
                "horas_extras_minutos": {
                    "description": "positivo se trabalhou mais",
                    "type": "integer"
                },
                "horas_faltantes_minutos": {
                    "description": "positivo se trabalhou menos",
                    "type": "integer"
                },
                "inconsistente": {
                    "type": "boolean"
                ...
                "justificativa": {
                    "$ref": "#/definitions/relatorio.JustificativaDTO"
                },
                "marcacoes": {
                    "type": "array",
                    "items": {
        ...
        "relatorio.RelatorioGeralDTO": {
            ...
            "properties": {
                ...
                "usuarios": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/relatorio.RelatorioUsuarioDTO"
                    }
                }
            }
        },
        "relatorio.RelatorioUsuarioDTO": {
            "type": "object",
            "properties": {
                "dias": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/relatorio.RelatorioDiaDTO"
                    }
                },
                "periodo": {
                    "$ref": "#/definitions/relatorio.PeriodoInterval"
                ...
                "resumo": {
                    "$ref": "#/definitions/relatorio.ResumoUsuarioDTO"
                },
                "usuario": {
                    "$ref": "#/definitions/relatorio.UsuarioInfoDTO"
                }
            }
        },
        "relatorio.ResumoUsuarioDTO": {
            "type": "object",
            "properties": {
                "saldo_banco_horas_final_minutos": {
                    "type": "integer"
                },
                "saldo_banco_horas_inicial_minutos": {
                    "type": "integer"
                },
                "total_horas_extras_hhmm": {
                    "type": "string"
                },
                "total_horas_extras_minutos": {
                    "type": "integer"
                },
                "total_horas_faltantes_hhmm": {
                    "type": "string"
                },
                "total_horas_faltantes_minutos": {
                    "type": "integer"
                },
                "total_horas_trabalhadas_hhmm": {
                    "type": "string"
                },
                "total_horas_trabalhadas_minutos": {
                    "type": "integer"
                }
            }
        },
